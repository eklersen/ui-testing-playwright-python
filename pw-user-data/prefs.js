...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1771095697);
user_pref("app.update.lastUpdateTime.background-update-timer", 1771095697);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1771095697);
user_pref("app.update.lastUpdateTime.region-update-timer", 1771095697);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1771095697);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1771096435);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1771095697);
user_pref("app.update.migrated.updateDir3.DD429F0330C77484", true);
...
user_pref("browser.contextual-services.contextId", "{32b88283-efe8-41ac-933b-81fb53b2b319}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{0795d74c-59f0-4e64-94a4-074d34a6a16c}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20240722213747");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1771096375);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECM78jhsIRgIBBAiw38WdBc0h1A==");
user_pref("extensions.formautofill.creditCards.supported", "off");
user_pref("extensions.getAddons.cache.enabled", false);
user_pref("extensions.installDistroAddons", false);
user_pref("extensions.lastAppBuildId", "20240722213747");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"b5966ad0-8f8e-4f2a-8958-b76150dcb632\",\"pictureinpicture@mozilla.org\":\"c37bcdca-8fc2-43cc-ac38-8e6f88d15928\",\"screenshots@mozilla.org\":\"f67cafd5-e175-40ee-9edc-da39e5956324\",\"webcompat-reporter@mozilla.org\":\"e4c22891-d366-471e-9ead-b54028449dc6\",\"webcompat@mozilla.org\":\"711298b3-e934-448b-8c11-c8aa5ab737e7\",\"default-theme@mozilla.org\":\"3ca7c7b9-755b-4338-8b5d-b286d856e2df\",\"addons-search-detection@mozilla.com\":\"802d5e49-3039-42ca-8380-64fd2c139a3d\"}");
...
user_pref("gfx-shader-check.build-version", "20240722213747");
user_pref("gfx-shader-check.device-id", "0x1900");
user_pref("gfx-shader-check.driver-version", "32.0.23017.1001");
...
user_pref("sanity-test.driver-version", "32.0.23017.1001");
user_pref("sanity-test.running", false);
user_pref("sanity-test.version", "20240722213747");
user_pref("security.certerrors.mitm.priming.enabled", false);
user_pref("security.fileuri.strict_origin_policy", false);
user_pref("security.notification_enable_delay", 0);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECDRRroTx0lduBAiYipY3oKojWQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1771096374);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "c0ffeec0-ffee-c0ff-eec0-ffeec0ffeec0");
user_pref("toolkit.telemetry.enabled", false);
user_pref("toolkit.telemetry.previousBuildID", "20240722213747");
